...
const TestPage = () => {
  ...
  const fetchLanguages = async () => {
    try {
      ...
      const response = await axios.get(
        `https://quiz-app-backend-ehiy.onrender.com/quiz/languages`,
        config
      );
  ...
  const getQuestions = async (lang_id, category) => {
    try {
      ...
      const response = await axios.post(
        "https://quiz-app-backend-ehiy.onrender.com/quiz/questions",
        {
          language_id: lang_id,
          category: category,
        },
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "https://quiz-app-backend-ehiy.onrender.com/quiz/answers",
        dataToSend,
        config
      );
